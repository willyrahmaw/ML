...
# Load model dan scaler
model_pumpkin = load_model('supervised/model.h5')  # Ganti dengan path model neural network Anda
scaler_pumpkin = load_scaler_and_encoder('supervised/scaler.pkl')  # Ganti dengan path scaler Anda
